...
export interface IStateSellOrdersPropertiesReducer {
    getAll: boolean;
    sell_orders: ISellOrderArgs[],
}

export interface IStateShippingMethodsPropertiesReducer {
    shipping_methods: IShippingMethods[],
}

export interface IStateSellOrdersReducer {
    sellOrdersReducer: IStateSellOrdersPropertiesReducer;
}

export interface IStateShippingMethodsReducer {
    shippingMethodsReducer: IStateShippingMethodsPropertiesReducer;
}